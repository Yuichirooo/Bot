    ...
    try:
        ...
        if msg.toType == 2:
            if msg.contentType == 0:
                ...
                if msg.text == "Gift":
                    sendMessage(msg.to, text="gift sent", contentMetadata=None, contentType=9)
                if msg.text == "Sebentar..":
                    sendMessage(msg.to, "Saya sudah menangkap siapa saja yang hanya menyimak.\nKetik [Dorr/dorr] untuk melihat list silent reader ♪")
                    try:
                ...
                if msg.text == "Siap":
                    if msg.to in wait['readPoint']:
                        ...
                        sendMessage(msg.to, "Ini yang sudah membaca : %s\nHahahaha\n\nIni daftar yang hanya membaca chat\n%sSungguh membuat heran ♪\n\nTanggal & Waktu :\n[%s]"  % (wait['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        sendMessage(msg.to, "Bot belum mensetting.\nKetik「Look/look」Untuk mensetting bot ♪")
                else:
                    pass
        else:
            pass
